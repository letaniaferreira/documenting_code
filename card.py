...
class Card:
    """
    The Card class represents a single player card and is initialised by passing a suit and a number.
    """
...
class Deck:
    """
    The Deck class represents the whole deck of cards and is initialised by passing cards.
    """
